...
window.SITE = {
  ...
  pages: {
    ...
    home: {
      ...
      blocks: [
        { type: "hero",
          title: { en: "Move with intention.\nRest with purpose.",
                   hi: "इरादे से चलें।\nसुकून से ठहरें।",
                   sa: "सङ्कल्पेन चल।\nशान्त्या तिष्ठ।" },
          subtitle: { en: "Free full-length yoga and mindful-fitness classes, filmed with care and open to everyone — no sign-up, no paywall.",
                      hi: "निःशुल्क, पूर्ण-अवधि योग कक्षाएँ — बिना साइन-अप, बिना पेवॉल, सबके लिए।",
                      sa: "निःशुल्काः पूर्णाः योगकक्षाः — सर्वेभ्यः उन्मुक्ताः।" },
        ...
        { type: "stats",
          items: [
            { value: "100%", label: { en: "free classes", hi: "निःशुल्क कक्षाएँ", sa: "निःशुल्क-कक्षाः" } },
